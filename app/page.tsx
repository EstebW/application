...
// ── New funnel:
// hero → upload → analyzing → teaser → signup → payment → generating → success
type Step = 'hero' | 'upload' | 'analyzing' | 'teaser' | 'signup' | 'payment' | 'generating' | 'success'
...
export default function HomePage() {
  ...
  const handlePaymentSuccess = useCallback(() => {
    setStep('generating')   // ← after payment → generate photo
  }, [])
  ...
  const noBack: Step[] = ['hero', 'analyzing', 'generating', 'signup', 'payment', 'success']
